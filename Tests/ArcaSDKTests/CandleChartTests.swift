...
final class CandleChartTests: XCTestCase {
    ...
    func testEnsureRangeFetchesGapsConcurrently() async throws {
        ...
        let stream = try await arca.watchCandleChart(market: "hl:0:BTC", interval: .oneMinute, count: 2)
    ...
    private func makeCandlesEnvelope(_ candles: [Candle]) -> String {
        ...
        return "{\"success\":true,\"data\":{\"market\":\"hl:0:BTC\",\"interval\":\"1m\",\"candles\":[\(candleJSON)]}}"
    }
