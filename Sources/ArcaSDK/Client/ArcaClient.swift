...
public final class ArcaClient: @unchecked Sendable {
    ...
    public func put<T: Decodable>(_ path: String, query: [String: String]? = nil, body: (any Encodable)? = nil) async throws -> T {
        try await executeWithAuthRetry(method: "PUT", path: path, query: query, body: body)
    }
